            ...
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="alert alert-success alert-block d-flex justify-content-between">
                            <div> <strong>{{ session()->get('seccess') }}
                                </strong> </div>
                            <div><button type="button" class="close" data-dismiss="alert">×</button></div>
                        </div>
                        @endif
                ...
                <div class="row tm-edit-product-row" style="justify-content: center;">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <form action="{{route('admin.addCategory')}}" method="post" class="tm-edit-product-form">
                            @csrf
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
                        <div class="">
                            <h2 class="tm-block-title text-center" style="margin-top:30px;">All Categories</h2>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('admin.changeCategoryStatus',$category->id)}}" class="btn btn-primary text-uppercase">Active</a>
                                            @else
                                                <a href="{{route('admin.changeCategoryStatus',$category->id)}}" class="btn btn-primary text-uppercase">Inactive</a>
                                            @endif
                                            <a href="{{route('admin.deleteCategory',$category->id)}}" class="tm-product-delete-link">
